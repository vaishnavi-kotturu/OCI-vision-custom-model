...
def create_project_callback(times_called, response):
    '''
    Callback function for create_project_and_wait_for_state
    '''
    print("[ Status:", response.data.status, "]")    
    
def create_model_callback(times_called, response):
    '''
    Callback function for create_model_and_wait_for_state
    '''
    print("[ Status:", response.data.status, "]", response.data.percent_complete, "% complete.")
